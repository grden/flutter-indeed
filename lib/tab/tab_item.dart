...
enum TabItem {
  studentHome(CupertinoIcons.compass_fill, '선생님 찾기', TeacherHomeFragment(), inActiveIcon: CupertinoIcons.compass),
  teacherHome(CupertinoIcons.compass_fill, '학생 찾기', StudentHomeFragment(), inActiveIcon: CupertinoIcons.compass),
