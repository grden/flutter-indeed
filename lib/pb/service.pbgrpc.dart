...
class GrpcServerServiceClient extends $grpc.Client {
  ...
  static final _$getUsers = $grpc.ClientMethod<$3.UsersListRequest, $3.ListUserMessage>(
      '/pb.GrpcServerService/GetUsers',
      ($3.UsersListRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $3.ListUserMessage.fromBuffer(value));
  static final _$sendMessage = $grpc.ClientMethod<$4.SendMessageRequest, $4.Message>(
      '/pb.GrpcServerService/SendMessage',
      ($4.SendMessageRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $4.Message.fromBuffer(value));
  static final _$getAllMessage = $grpc.ClientMethod<$4.GetAllMessagesRequest, $4.GetAllMessagesResponse>(
      '/pb.GrpcServerService/GetAllMessage',
      ($4.GetAllMessagesRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $4.GetAllMessagesResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$3.ListUserMessage> getUsers($3.UsersListRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getUsers, request, options: options);
  }

  $grpc.ResponseStream<$4.Message> sendMessage($async.Stream<$4.SendMessageRequest> request, {$grpc.CallOptions? options}) {
    return $createStreamingCall(_$sendMessage, request, options: options);
  }

  $grpc.ResponseFuture<$4.GetAllMessagesResponse> getAllMessage($4.GetAllMessagesRequest request, {$grpc.CallOptions? options}) {
...
abstract class GrpcServerServiceBase extends $grpc.Service {
  ...
  GrpcServerServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$3.UsersListRequest, $3.ListUserMessage>(
        'GetUsers',
        getUsers_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $3.UsersListRequest.fromBuffer(value),
        ($3.ListUserMessage value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$4.SendMessageRequest, $4.Message>(
        'SendMessage',
        sendMessage,
        true,
        true,
        ($core.List<$core.int> value) => $4.SendMessageRequest.fromBuffer(value),
        ($4.Message value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$4.GetAllMessagesRequest, $4.GetAllMessagesResponse>(
        'GetAllMessage',
        getAllMessage_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $4.GetAllMessagesRequest.fromBuffer(value),
        ($4.GetAllMessagesResponse value) => value.writeToBuffer()));
  }
  ...
  $async.Future<$3.ListUserMessage> getUsers_Pre($grpc.ServiceCall call, $async.Future<$3.UsersListRequest> request) async {
    return getUsers(call, await request);
  }

  $async.Future<$4.GetAllMessagesResponse> getAllMessage_Pre($grpc.ServiceCall call, $async.Future<$4.GetAllMessagesRequest> request) async {
  ...
  $async.Future<$3.ListUserMessage> getUsers($grpc.ServiceCall call, $3.UsersListRequest request);
  $async.Stream<$4.Message> sendMessage($grpc.ServiceCall call, $async.Stream<$4.SendMessageRequest> request);
  $async.Future<$4.GetAllMessagesResponse> getAllMessage($grpc.ServiceCall call, $4.GetAllMessagesRequest request);
}
